...
<tei:TEI xmlns:tei="http://www.tei-c.org/ns/1.0" xmlns:j="http://jewishliturgy.org/ns/jlptei/1.0">
    ...
    <tei:text>
      <j:streamText xml:id="stream">
        <tei:anchor xml:id="begin_p_1"/>
        <tei:anchor xml:id="seg_1"/>
        seg 1
        middle segment.
        <tei:anchor xml:id="seg_3"/>
        <tei:w>segment</tei:w>
        <tei:w>with</tei:w>
        <tei:w>internal</tei:w>
        <tei:w>structure</tei:w>
        <tei:anchor xml:id="seg_3_end"/>
        <tei:ptr xml:id="internal_ptr_to_segments" target="#range(seg_1,seg_3_end)"/>
        <tei:ptr xml:id="internal_ptr_to_one_segment" target="#range(seg_3,seg_3_end)"/>
        <tei:anchor xml:id="end_p_1"/>
        <tei:anchor xml:id="seg_4"/>Referenced by an internal pointer
        Outside a streamText
        <tei:anchor xml:id="seg_5_end"/>
        <tei:anchor xml:id="begin_p_3"/>
        <tei:anchor xml:id="seg_6"/>Referenced externally without a range
        <tei:anchor xml:id="seg_6_end"/>
        Unreferenced.
        <tei:anchor xml:id="seg_8"/>Referenced externally
        with
        a range.<tei:anchor xml:id="seg_10_end"/>
        <tei:anchor xml:id="end_p_3"/>
      </j:streamText>
      <j:concurrent type="p">
        <tei:p>
...
declare
  ...
  let $do-upgrade := upg12:upgrade(doc($t:storage-collection || "/" || $t:reference-file-resource))
  let $post-upgrade-external-reference-file := doc($t:storage-collection || "/" || $t:external-reference-file-resource)
  return $post-upgrade-external-reference-file
};