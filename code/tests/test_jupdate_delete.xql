(: Unit test code for deleting of an item in the database.
 ...
 :
 : $Id: test_jupdate_delete.xql 411 2010-01-03 06:58:09Z efraim.feinstein $
 :)
xquery version "1.0";
...
declare variable $toDelete := 
    //id('toby.deleted');

<a>{jupdate:delete($toDelete)}</a>